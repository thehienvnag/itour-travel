...
public class CheckLoginUserFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (dto != null && dto.getRoleId() == Config.ROLE_USER) {
                chain.doFilter(request, response);
            } else {
                if (Util.isSomeNotNullParams(location, txtPriceRange, txtDateStart, txtDateEnd)) {
                    String urlRewriting = "search-tour?"
                    ...
                    session.setAttribute(Config.ATTR_LAST_SEARCH_URL, urlRewriting);
                }
                req.getRequestDispatcher(url).forward(request, response);
            }
        } catch (Throwable t) {
            Logger.log("Throwable: " + t.getMessage(), CheckLoginUserFilter.class);
        }
    }
