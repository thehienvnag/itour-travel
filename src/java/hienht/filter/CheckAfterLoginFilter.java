...
public class CheckAfterLoginFilter implements Filter {
    ...
    public CheckAfterLoginFilter() {
    }

    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckAfterLoginFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckAfterLoginFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            RegistrationDTO dto = (RegistrationDTO) session.getAttribute(Config.ATTR_USER);
            if (dto == null) {
                chain.doFilter(request, response);
            } else {
                res.sendRedirect(Config.PAGE_HOME);
            }
        } catch (Throwable t) {
            Logger.log("Throwable: " + t.getMessage(), CheckAfterLoginFilter.class);
        }
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("CheckAfterLoginFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CheckAfterLoginFilter()");
        }
        StringBuffer sb = new StringBuffer("CheckAfterLoginFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("CheckAfterLoginFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("CheckAfterLoginFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("CheckAfterLoginFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("CheckAfterLoginFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("CheckAfterLoginFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
